...
export default function Page() {
  ...
  const validateForm = () => {
    if (!data.nama_customer || !data.email_customer || !data.notelp_customer || !data.password_customer) {
      setError("Semua input harus diisi.");
      return false;
    }
    if (data.password_customer.length < 8) {
      setError("Password minimal 8 karakter.");
      return false;
    }
    if (data.notelp_customer.length < 11 || data.notelp_customer.length > 14) {
      setError("Nomor telepon harus memiliki panjang 11-14 karakter.");
      return false;
    }
    return true;
  }
  ...
  <>
    <HomePageLayout>
      <div className="flex justify-center items-center h-screen w-full">
        <div className="bg-white rounded-3xl p-8 mt-20 md:w-[50rem] bg-opacity-70 w-full">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-5">
              ...
              >
                ...
                <a
                  href="/login"
                  className="text-[#AD773D] font-serif text-center mt-1 mb-8 hover:text-[#AD773D]"
                  style={{ fontSize: "14px" }}
                >
                  Login
                </a>
